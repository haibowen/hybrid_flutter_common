...
import 'package:gm_flutter/CityFilterModel/service/entity/CityFilterBean.dart';
import 'package:gm_flutter/CityFilterModel/service/entity/CityFilterResultBean.dart';
...
abstract class CityFilterApi {
  ...
  CityFilterResultBean getFilterCities(@Query("keyword") String keyword, int num, bool isShow);
}
